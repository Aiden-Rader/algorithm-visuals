...
<?php
	$page = [
		'title'       => 'Data Structures | ' . SITE_TITLE,
		'description' => 'Dive into the world of essential data structures and learn how they efficiently organize and manage data.',
		'css'         => ['/data-structures-page/data_structures.css'],
		'js'          => ['/data-structures-page/data_structures.js', '/common/scripts/nav_bar.js', '/common/scripts/footer.js'],
		'coderunner'  => false,
		'use_gsap'    => true
	];
