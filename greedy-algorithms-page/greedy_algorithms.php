<!-- Greedy Algorithms Home Page of website -->
...
<head>
	...
	<title>Greedy Algorithms | <?= SITE_TITLE ?></title>
</head>
...
<body>
		...
		<div class="main p-3">
			...
			<div class="card mb-4 header-card">
				<div class="card-body text-center">
					<h1 class="card-title display-4 typing-text" id="typing-text-GreedyA"></h1>
					<p class="card-text lead">Greedy algorithms make the best choice at the moment, without considering the future. They are used to find efficient solutions to optimization problems.</p>
				</div>
			</div>
	...
	<!-- Scripts for Greedy Algorithms Page goes here -->
	<script src="greedy_algorithms.js" defer></script>
</body>