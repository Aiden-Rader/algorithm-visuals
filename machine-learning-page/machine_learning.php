<!-- Machine Learning Home Page of website -->
...
<head>
	...
	<title>Machine Learning | <?= SITE_TITLE ?></title>
</head>
...
<body>
		...
		<div class="main p-3">
			...
			<div class="card mb-4 header-card">
				<div class="card-body text-center">
					<h1 class="card-title display-4 typing-text" id="typing-text-MachineL"></h1>
					<p class="card-text lead">Machine Learning is a subset of Artificial Intelligence that involves the use of algorithms and statistical models to enable machines to learn from data, make decisions, and improve their performance on a task over time.</p>
				</div>
			</div>
	...
	<!-- Scripts for Machine Learning Page goes here -->
	<script src="machine_learning.js" defer></script>
</body>