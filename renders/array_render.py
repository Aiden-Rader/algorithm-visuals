...
class ArrayRender(Scene):
	...
	def display_array(self, box_color=BLUE, text_color=WHITE, include_indices=True):
		"""
		Displays an array as a series of boxes with text inside.

		Args:
			array_data (list): The data to display in the array.
			box_color (Color): The color of the array boxes.
			text_color (Color): The color of the text inside the boxes.
			include_indices (bool): Whether to include indices below the boxes.
		"""
